...
//Override buttons for enabling antennas without using DTMF codes
#define CPOL_EN_BTN  5 
#define VPOL_EN_BTN  6
//**********************   Port D Pins     ****************************
...
*/
char cpolEnablingSequence[CODE_LENGTH] = {'5','6','7','8','9'};
char vpolEnablingSequence[CODE_LENGTH]  = {'9','8','7','6','5'};
//*********************************************************************
...
ISR (PCINT0_vect){
    portBStatus = PINB;
        ...
        else if(portBStatus & 0x40){
          STATE = ENABLE_VPOL;      
        }
        else if(portBStatus > 0x0F ){
